...
Avoid heavy frameworks, databases, background services, and unnecessary
dependencies.
...
- Date: 2026-06-02
- Changed by: Codex
- Reason: Separate stable project intent from short-term handoff state.
- Summary: Added `PROJECT_BRIEF.md` as the long-term AI project context layer
  while keeping `HANDOFF.md` focused on bounded transition state.
